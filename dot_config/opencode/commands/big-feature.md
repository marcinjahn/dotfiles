...
- Make sure to use appropriate subagents to delegate subtasks. First, use feature-architect to plan
  the work, and ask me if I like the plan, and/or ask me clarifying questions. Once I agree to move on
  with the plan, use appropriate code writer subagent(s) to work on the implementation in manageable
  chunks.
...
- do not print obvious information in the summary after the job/subtask gets done. Only print useful non-obvious details of the implementation.
